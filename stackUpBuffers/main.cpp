...
int main(void)
{
	...
	AFramebuffer stackedBuffer(width * 2, height * 2);
	
	std::vector<GLuint> textures = {stackedBuffer.getFramebufferTexture(), edgeBuffer.getFramebufferTexture()};
